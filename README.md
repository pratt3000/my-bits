...
- **Tap** a glowing creature or word to collect it (walk close enough first).
- **Tap the trees** to rustle their leaves.

### How it works

- Endless forest: the ground and a pool of instanced trees recycle around the
  player, so you can walk forever without hitting an edge.
